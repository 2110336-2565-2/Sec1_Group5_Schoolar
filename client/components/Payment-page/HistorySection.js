...
const HistorySection = ({ scholarships }) => {
                        ...
                        <Grid container width="100%" spacing={2} justifyContent="space-between">
                            <Grid item xs={6}>
                                <Stack direction="row" alignItems="center" spacing={1}>
                                    ...
                                    <Typography sx={{ typography: { xs: "body2", sm: "body1" } }}>{changeDateToString(item.date)}</Typography>
                                </Stack>
                            </Grid>
                            <Grid item xs={6}>
                                <Stack direction="row" alignItems="center" spacing={1}>
                                    ...
                                    <Typography sx={{ color: "green", typography: { xs: "body2", sm: "body1" } }}>
                                        Amount paid {item.amount} {item.currency}</Typography>
                                </Stack>
                            </Grid>
                        </Grid>
                    </Box>)
    ...
    return (
            <Box sx={{
                ...
                <Typography variant="h2" sx={{ fontWeight: 'bold' }} padding={1}>History</Typography>
            
                <Stack direction="row" spacing={{ xs: 1, sm: 3 }} sx={{ m: {xs: 1,sm:2}, p: {xs: 1,sm:2}, overflow: "auto"}}>
